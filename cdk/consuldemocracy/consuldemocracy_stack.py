...
# make TEMPLATE_VERSION=2.0.1 ami-ec2-build (prod) on Sun Jul 19 17:51 UTC 2026.
# (dev AMI: ami-0ccc6a5f6e79a6544 - restored on develop in Phase 7.2)
AMI_ID="ami-033b419e656735ccb"
AMI_NAME="ordinary-experts-patterns-consuldemocracy-2.0.1-20260719-0329"
NEXT_RELEASE_PREFIX = "v201"
generated_ami_ids = {
    ...
    "us-east-1": "ami-033b419e656735ccb"
}
# End generated code block.

class ConsuldemocracyStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        with open("consuldemocracy/user_data.sh") as f:
            user_data = f.read()
        asg = Asg(
            self,
            "Asg",
