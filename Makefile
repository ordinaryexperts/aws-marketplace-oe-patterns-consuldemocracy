...
update-common:
	wget -O common.mk https://raw.githubusercontent.com/ordinaryexperts/aws-marketplace-utilities/refs/tags/1.10.3/common.mk
...
deploy: build
	...
	--parameters AsgAmiIdv201=ami-0ccc6a5f6e79a6544 \
