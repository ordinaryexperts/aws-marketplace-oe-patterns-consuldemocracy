...
update-common:
	wget -O common.mk https://github.com/ordinaryexperts/aws-marketplace-utilities/blob/feature/common-scripts/common.mk
...
deploy: build
	...
	--parameters DnsHostname=consul-${USER}.dev.patterns.ordinaryexperts.com \
